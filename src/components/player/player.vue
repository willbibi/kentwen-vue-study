  ...
  export default{
    ...
    methods: {
      ...
      onProgressBarChange(val) {
        const currentTime = this.currentSong.duration * val
      ...
      middleTouchMove(e) {
        ...
        this.$refs.middleL.sytle[transitionDuration] = 0
      },
      middleTouchEnd() {
        let offsetWidth
        let opacity
        ...
        this.$refs.middleL.sytle[transitionDuration] = `${time}ms`
      },
      _pad(num, n = 2) {
